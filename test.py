...
def dvije_rijeci_prva_numeric(rijec, folder, rijecnik, txt_broj):
	global neki_tamo_brojac
	...
	os.system("crunch {0} {0} -t {1}%{2} -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 1, rijecnik[1][rijec], rijecnik[0][rijec], folder, txt_broj + 18))
	neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 18))
	os.system("crunch {0} {0} -t {1}%%{2} -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 2, rijecnik[1][rijec], rijecnik[0][rijec], folder, txt_broj + 19))
	...
	os.system("crunch {0} {0} -t {1}%{2}% -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 2, rijecnik[1][rijec], rijecnik[0][rijec], folder, txt_broj + 22))
	neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 22))
	os.system("crunch {0} {0} -t {1}%%{2}% -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 3, rijecnik[1][rijec], rijecnik[0][rijec], folder, txt_broj + 23))
	neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 23))
	os.system("crunch {0} {0} -t {1}%{2}%% -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 3, rijecnik[1][rijec], rijecnik[0][rijec], folder, txt_broj + 24))
	...
	os.system("crunch {0} {0} -t {1}%%{2}%% -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 4, rijecnik[1][rijec], rijecnik[0][rijec], folder, txt_broj + 26))
