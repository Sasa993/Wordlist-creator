...
def vise_rijeci_prva_numeric(broj_rijeci, folder, rijecnik, txt_broj):
	global neki_tamo_brojac
	...
	if (broj_rijeci == 2):
		...
		#combo 2 names
		os.system("crunch {0} {0} -t {1}{2}% -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 1, rijecnik[1]['rijec'], rijecnik[0]['rijec'], folder, txt_broj))
		neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj))
		os.system("crunch {0} {0} -t {1}{2}%% -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 2, rijecnik[1]['rijec'], rijecnik[0]['rijec'], folder, txt_broj + 1))
		neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 30))
		os.system("crunch {0} {0} -t {1}{2}%%% -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 3, rijecnik[1]['rijec'], rijecnik[0]['rijec'], folder, txt_broj + 2))
		neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 31))
		os.system("crunch {0} {0} -t {1}{2}%%%% -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 4, rijecnik[1]['rijec'], rijecnik[0]['rijec'], folder, txt_broj + 3))
		neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 32))
		os.system("crunch {0} {0} -t {1}%{2} -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 1, rijecnik[1]['rijec'], rijecnik[0]['rijec'], folder, txt_broj + 4))
		neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 33))
		os.system("crunch {0} {0} -t {1}%%{2} -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 2, rijecnik[1]['rijec'], rijecnik[0]['rijec'], folder, txt_broj + 5))
		neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 34))
		os.system("crunch {0} {0} -t {1}%%%{2} -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 3, rijecnik[1]['rijec'], rijecnik[0]['rijec'], folder, txt_broj + 6))
		neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 35))
		os.system("crunch {0} {0} -t {1}%%%%{2} -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 4, rijecnik[1]['rijec'], rijecnik[0]['rijec'], folder, txt_broj + 7))
		neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 36))
		os.system("crunch {0} {0} -t {1}%{2}% -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 2, rijecnik[1]['rijec'], rijecnik[0]['rijec'], folder, txt_broj + 8))
		neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 37))
		os.system("crunch {0} {0} -t {1}%%{2}% -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 3, rijecnik[1]['rijec'], rijecnik[0]['rijec'], folder, txt_broj + 9))
		neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 38))
		os.system("crunch {0} {0} -t {1}%{2}%% -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 3, rijecnik[1]['rijec'], rijecnik[0]['rijec'], folder, txt_broj + 10))
		neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 39))
		os.system("crunch {0} {0} -t {1}%%%{2}% -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 4, rijecnik[1]['rijec'], rijecnik[0]['rijec'], folder, txt_broj + 11))
		neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 40))
		os.system("crunch {0} {0} -t {1}%%{2}%% -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 4, rijecnik[1]['rijec'], rijecnik[0]['rijec'], folder, txt_broj + 12))
		neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 41))
		os.system("crunch {0} {0} -t {1}%{2}%%% -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 4, rijecnik[1]['rijec'], rijecnik[0]['rijec'], folder, txt_broj + 13))
		neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 42))
		os.system("crunch {0} {0} -t %{1}{2} -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 1, rijecnik[1]['rijec'], rijecnik[0]['rijec'], folder, txt_broj + 14))
		neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 43))
		os.system("crunch {0} {0} -t %%{1}{2} -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 2, rijecnik[1]['rijec'], rijecnik[0]['rijec'], folder, txt_broj + 15))
		neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 44))
		os.system("crunch {0} {0} -t %%%{1}{2} -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 3, rijecnik[1]['rijec'], rijecnik[0]['rijec'], folder, txt_broj + 16))
		neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 45))
		os.system("crunch {0} {0} -t %%%%{1}{2} -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 4, rijecnik[1]['rijec'], rijecnik[0]['rijec'], folder, txt_broj + 17))
		neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 46))
		os.system("crunch {0} {0} -t %{1}%{2} -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 2, rijecnik[1]['rijec'], rijecnik[0]['rijec'], folder, txt_broj + 18))
		neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 47))
		os.system("crunch {0} {0} -t %%{1}%{2} -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 3, rijecnik[1]['rijec'], rijecnik[0]['rijec'], folder, txt_broj + 19))
		neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 48))
		os.system("crunch {0} {0} -t %{1}%%{2} -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 3, rijecnik[1]['rijec'], rijecnik[0]['rijec'], folder, txt_broj + 20))
		neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 49))
		os.system("crunch {0} {0} -t %{1}%%%{2} -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 4, rijecnik[1]['rijec'], rijecnik[0]['rijec'], folder, txt_broj + 21))
		neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 50))
		os.system("crunch {0} {0} -t %%{1}%%{2} -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 4, rijecnik[1]['rijec'], rijecnik[0]['rijec'], folder, txt_broj + 22))
		...
		os.system("crunch {0} {0} -t %{1}{2}% -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 2, rijecnik[1]['rijec'], rijecnik[0]['rijec'], folder, txt_broj + 24))
		neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 53))
		os.system("crunch {0} {0} -t %%{1}{2}% -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 3, rijecnik[1]['rijec'], rijecnik[0]['rijec'], folder, txt_broj + 25))
		neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 54))
		os.system("crunch {0} {0} -t %{1}{2}%% -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 3, rijecnik[1]['rijec'], rijecnik[0]['rijec'], folder, txt_broj + 26))
		neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 55))
		os.system("crunch {0} {0} -t %%{1}{2}%% -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 4, rijecnik[1]['rijec'], rijecnik[0]['rijec'], folder, txt_broj + 27))
		neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 56))
		os.system("crunch {0} {0} -t %%%{1}{2}% -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 4, rijecnik[1]['rijec'], rijecnik[0]['rijec'], folder, txt_broj + 28))
