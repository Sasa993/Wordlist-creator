...
#functions with 3 words start here 
#please fix parameters (it should be something like prva_rijec, druga_rijec, treca_rijec, folder, rijecnik, txt_broj)
...
****************************************
	...
	dvije_rijeci_prva_mix_lower_upper_numeric("rijec", "rijec", naziv_foldera, sve_rijeci_dictionary)
	dvije_rijeci_prva_mix_lower_upper_numeric("rijec_prvo_slovo_upper", "rijec", naziv_foldera, sve_rijeci_dictionary)
	dvije_rijeci_prva_mix_lower_upper_numeric("rijec_prvo_slovo_upper", "rijec_prvo_slovo_upper", naziv_foldera, sve_rijeci_dictionary)
	dvije_rijeci_prva_mix_lower_upper_numeric("rijec", "rijec_prvo_slovo_upper", naziv_foldera, sve_rijeci_dictionary)

	print("\nVelicina foldera iznosi:\n{0:.2f}MB".format(float(neki_tamo_brojac)/1024/1024))

	dvije_rijeci_prva_mix_lower_upper_numeric("rijec_zadnje_slovo_upper", "rijec", naziv_foldera, sve_rijeci_dictionary)
	dvije_rijeci_prva_mix_lower_upper_numeric("rijec_zadnje_slovo_upper", "rijec_zadnje_slovo_upper", naziv_foldera, sve_rijeci_dictionary)
	dvije_rijeci_prva_mix_lower_upper_numeric("rijec", "rijec_zadnje_slovo_upper", naziv_foldera, sve_rijeci_dictionary)

	print("\nVelicina foldera iznosi:\n{0:.2f}MB".format(float(neki_tamo_brojac)/1024/1024))

	dvije_rijeci_prva_mix_lower_upper_numeric("rijec_sva_slova_upper", "rijec", naziv_foldera, sve_rijeci_dictionary)
	dvije_rijeci_prva_mix_lower_upper_numeric("rijec_sva_slova_upper", "rijec_sva_slova_upper", naziv_foldera, sve_rijeci_dictionary)
	dvije_rijeci_prva_mix_lower_upper_numeric("rijec", "rijec_sva_slova_upper", naziv_foldera, sve_rijeci_dictionary)

	print("\nVelicina foldera iznosi:\n{0:.2f}MB".format(float(neki_tamo_brojac)/1024/1024))

	dvije_rijeci_druga_mix_lower_upper_numeric("rijec", "rijec", naziv_foldera, sve_rijeci_dictionary)
	dvije_rijeci_druga_mix_lower_upper_numeric("rijec_prvo_slovo_upper", "rijec", naziv_foldera, sve_rijeci_dictionary)
	dvije_rijeci_druga_mix_lower_upper_numeric("rijec_prvo_slovo_upper", "rijec_prvo_slovo_upper", naziv_foldera, sve_rijeci_dictionary)
	dvije_rijeci_druga_mix_lower_upper_numeric("rijec", "rijec_prvo_slovo_upper", naziv_foldera, sve_rijeci_dictionary)

	print("\nVelicina foldera iznosi:\n{0:.2f}MB".format(float(neki_tamo_brojac)/1024/1024))

	dvije_rijeci_druga_mix_lower_upper_numeric("rijec_zadnje_slovo_upper", "rijec", naziv_foldera, sve_rijeci_dictionary)
	dvije_rijeci_druga_mix_lower_upper_numeric("rijec_zadnje_slovo_upper", "rijec_zadnje_slovo_upper", naziv_foldera, sve_rijeci_dictionary)
	dvije_rijeci_druga_mix_lower_upper_numeric("rijec", "rijec_zadnje_slovo_upper", naziv_foldera, sve_rijeci_dictionary)

	print("\nVelicina foldera iznosi:\n{0:.2f}MB".format(float(neki_tamo_brojac)/1024/1024))

	dvije_rijeci_druga_mix_lower_upper_numeric("rijec_sva_slova_upper", "rijec", naziv_foldera, sve_rijeci_dictionary)
	dvije_rijeci_druga_mix_lower_upper_numeric("rijec_sva_slova_upper", "rijec_sva_slova_upper", naziv_foldera, sve_rijeci_dictionary)
	dvije_rijeci_druga_mix_lower_upper_numeric("rijec", "rijec_sva_slova_upper", naziv_foldera, sve_rijeci_dictionary)
