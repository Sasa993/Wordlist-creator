...
def dvije_rijeci_prva_mix_lower_numeric(prva_rijec, druga_rijec, folder, rijecnik, txt_broj):
	...
	neki_tamo_brojac += os.path.getsize('{0}{1}/{2}.txt'.format(folder_path, folder, txt_broj + 35))
	#combo 2 names
	os.system("crunch {0} {0} -t @%{1}{2} -o {3}{4}/{5}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 2, rijecnik[1][prva_rijec], rijecnik[0][druga_rijec], folder_path, folder, txt_broj))
	neki_tamo_brojac += os.path.getsize('{0}{1}/{2}.txt'.format(folder_path, folder, txt_broj + 36))
	os.system("crunch {0} {0} -t %@{1}{2} -o {3}{4}/{5}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 2, rijecnik[1][prva_rijec], rijecnik[0][druga_rijec], folder_path, folder, txt_broj + 1))
	neki_tamo_brojac += os.path.getsize('{0}{1}/{2}.txt'.format(folder_path, folder, txt_broj + 37))
	os.system("crunch {0} {0} -t @{1}%{2} -o {3}{4}/{5}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 2, rijecnik[1][prva_rijec], rijecnik[0][druga_rijec], folder_path, folder, txt_broj + 2))
	neki_tamo_brojac += os.path.getsize('{0}{1}/{2}.txt'.format(folder_path, folder, txt_broj + 38))
	os.system("crunch {0} {0} -t %{1}@{2} -o {3}{4}/{5}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 2, rijecnik[1][prva_rijec], rijecnik[0][druga_rijec], folder_path, folder, txt_broj + 3))
	neki_tamo_brojac += os.path.getsize('{0}{1}/{2}.txt'.format(folder_path, folder, txt_broj + 39))
	os.system("crunch {0} {0} -t {1}@%{2} -o {3}{4}/{5}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 2, rijecnik[1][prva_rijec], rijecnik[0][druga_rijec], folder_path, folder, txt_broj + 4))
	neki_tamo_brojac += os.path.getsize('{0}{1}/{2}.txt'.format(folder_path, folder, txt_broj + 40))
	os.system("crunch {0} {0} -t {1}%@{2} -o {3}{4}/{5}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 2, rijecnik[1][prva_rijec], rijecnik[0][druga_rijec], folder_path, folder, txt_broj + 5))
	neki_tamo_brojac += os.path.getsize('{0}{1}/{2}.txt'.format(folder_path, folder, txt_broj + 41))
	os.system("crunch {0} {0} -t {1}@@%{2} -o {3}{4}/{5}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 3, rijecnik[1][prva_rijec], rijecnik[0][druga_rijec], folder_path, folder, txt_broj + 6))
	neki_tamo_brojac += os.path.getsize('{0}{1}/{2}.txt'.format(folder_path, folder, txt_broj + 42))
	os.system("crunch {0} {0} -t {1}@%@{2} -o {3}{4}/{5}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 3, rijecnik[1][prva_rijec], rijecnik[0][druga_rijec], folder_path, folder, txt_broj + 7))
	neki_tamo_brojac += os.path.getsize('{0}{1}/{2}.txt'.format(folder_path, folder, txt_broj + 43))
	os.system("crunch {0} {0} -t {1}%@@{2} -o {3}{4}/{5}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 3, rijecnik[1][prva_rijec], rijecnik[0][druga_rijec], folder_path, folder, txt_broj + 8))
	neki_tamo_brojac += os.path.getsize('{0}{1}/{2}.txt'.format(folder_path, folder, txt_broj + 44))
	os.system("crunch {0} {0} -t {1}%%@{2} -o {3}{4}/{5}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 3, rijecnik[1][prva_rijec], rijecnik[0][druga_rijec], folder_path, folder, txt_broj + 9))
	neki_tamo_brojac += os.path.getsize('{0}{1}/{2}.txt'.format(folder_path, folder, txt_broj + 45))
	os.system("crunch {0} {0} -t {1}%@%{2} -o {3}{4}/{5}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 3, rijecnik[1][prva_rijec], rijecnik[0][druga_rijec], folder_path, folder, txt_broj + 10))
	neki_tamo_brojac += os.path.getsize('{0}{1}/{2}.txt'.format(folder_path, folder, txt_broj + 46))
	os.system("crunch {0} {0} -t {1}@%%{2} -o {3}{4}/{5}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 3, rijecnik[1][prva_rijec], rijecnik[0][druga_rijec], folder_path, folder, txt_broj + 11))
	neki_tamo_brojac += os.path.getsize('{0}{1}/{2}.txt'.format(folder_path, folder, txt_broj + 47))
	os.system("crunch {0} {0} -t @@%{1}{2} -o {3}{4}/{5}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 3, rijecnik[1][prva_rijec], rijecnik[0][druga_rijec], folder_path, folder, txt_broj + 12))
	neki_tamo_brojac += os.path.getsize('{0}{1}/{2}.txt'.format(folder_path, folder, txt_broj + 48))
	os.system("crunch {0} {0} -t @%@{1}{2} -o {3}{4}/{5}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 3, rijecnik[1][prva_rijec], rijecnik[0][druga_rijec], folder_path, folder, txt_broj + 13))
	neki_tamo_brojac += os.path.getsize('{0}{1}/{2}.txt'.format(folder_path, folder, txt_broj + 49))
	os.system("crunch {0} {0} -t %@@{1}{2} -o {3}{4}/{5}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 3, rijecnik[1][prva_rijec], rijecnik[0][druga_rijec], folder_path, folder, txt_broj + 14))
	neki_tamo_brojac += os.path.getsize('{0}{1}/{2}.txt'.format(folder_path, folder, txt_broj + 50))
	os.system("crunch {0} {0} -t %%@{1}{2} -o {3}{4}/{5}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 3, rijecnik[1][prva_rijec], rijecnik[0][druga_rijec], folder_path, folder, txt_broj + 15))
	neki_tamo_brojac += os.path.getsize('{0}{1}/{2}.txt'.format(folder_path, folder, txt_broj + 51))
	os.system("crunch {0} {0} -t %@%{1}{2} -o {3}{4}/{5}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 3, rijecnik[1][prva_rijec], rijecnik[0][druga_rijec], folder_path, folder, txt_broj + 16))
	neki_tamo_brojac += os.path.getsize('{0}{1}/{2}.txt'.format(folder_path, folder, txt_broj + 52))
	os.system("crunch {0} {0} -t @%%{1}{2} -o {3}{4}/{5}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 3, rijecnik[1][prva_rijec], rijecnik[0][druga_rijec], folder_path, folder, txt_broj + 17))
	neki_tamo_brojac += os.path.getsize('{0}{1}/{2}.txt'.format(folder_path, folder, txt_broj + 53))
	os.system("crunch {0} {0} -t @@{1}%{2} -o {3}{4}/{5}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 3, rijecnik[1][prva_rijec], rijecnik[0][druga_rijec], folder_path, folder, txt_broj + 18))
	neki_tamo_brojac += os.path.getsize('{0}{1}/{2}.txt'.format(folder_path, folder, txt_broj + 54))
	os.system("crunch {0} {0} -t @%{1}@{2} -o {3}{4}/{5}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 3, rijecnik[1][prva_rijec], rijecnik[0][druga_rijec], folder_path, folder, txt_broj + 19))
	neki_tamo_brojac += os.path.getsize('{0}{1}/{2}.txt'.format(folder_path, folder, txt_broj + 55))
	os.system("crunch {0} {0} -t %@{1}@{2} -o {3}{4}/{5}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 3, rijecnik[1][prva_rijec], rijecnik[0][druga_rijec], folder_path, folder, txt_broj + 20))
	neki_tamo_brojac += os.path.getsize('{0}{1}/{2}.txt'.format(folder_path, folder, txt_broj + 56))
	os.system("crunch {0} {0} -t %%{1}@{2} -o {3}{4}/{5}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 3, rijecnik[1][prva_rijec], rijecnik[0][druga_rijec], folder_path, folder, txt_broj + 21))
...
def dvije_rijeci_druga_mix_lower_numeric(prva_rijec, druga_rijec, folder, rijecnik, txt_broj):
	...
	os.system("crunch {0} {0} -t %{1}{2}@ -o {3}{4}/{5}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 2, rijecnik[1][prva_rijec], rijecnik[0][druga_rijec], folder_path, folder, txt_broj + 3))
	neki_tamo_brojac += os.path.getsize('{0}{1}/{2}.txt'.format(folder_path, folder, txt_broj + 27))
	os.system("crunch {0} {0} -t {1}@{2}@% -o {3}{4}/{5}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 3, rijecnik[1][prva_rijec], rijecnik[0][druga_rijec], folder_path, folder, txt_broj + 4))
	neki_tamo_brojac += os.path.getsize('{0}{1}/{2}.txt'.format(folder_path, folder, txt_broj + 28))
	os.system("crunch {0} {0} -t {1}@{2}%@ -o {3}{4}/{5}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 3, rijecnik[1][prva_rijec], rijecnik[0][druga_rijec], folder_path, folder, txt_broj + 5))
	neki_tamo_brojac += os.path.getsize('{0}{1}/{2}.txt'.format(folder_path, folder, txt_broj + 29))
	os.system("crunch {0} {0} -t {1}@{2}%% -o {3}{4}/{5}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 3, rijecnik[1][prva_rijec], rijecnik[0][druga_rijec], folder_path, folder, txt_broj + 6))
	neki_tamo_brojac += os.path.getsize('{0}{1}/{2}.txt'.format(folder_path, folder, txt_broj + 30))
	os.system("crunch {0} {0} -t {1}%{2}@@ -o {3}{4}/{5}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 3, rijecnik[1][prva_rijec], rijecnik[0][druga_rijec], folder_path, folder, txt_broj + 7))
	...
	os.system("crunch {0} {0} -t {1}@%{2}% -o {3}{4}/{5}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 3, rijecnik[1][prva_rijec], rijecnik[0][druga_rijec], folder_path, folder, txt_broj + 15))
	neki_tamo_brojac += os.path.getsize('{0}{1}/{2}.txt'.format(folder_path, folder, txt_broj + 39))
	os.system("crunch {0} {0} -t {1}{2}%@ -o {3}{4}/{5}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 2, rijecnik[1][prva_rijec], rijecnik[0][druga_rijec], folder_path, folder, txt_broj + 16))
	neki_tamo_brojac += os.path.getsize('{0}{1}/{2}.txt'.format(folder_path, folder, txt_broj + 40))
	os.system("crunch {0} {0} -t {1}{2}@% -o {3}{4}/{5}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 2, rijecnik[1][prva_rijec], rijecnik[0][druga_rijec], folder_path, folder, txt_broj + 17))
	neki_tamo_brojac += os.path.getsize('{0}{1}/{2}.txt'.format(folder_path, folder, txt_broj + 41))
	os.system("crunch {0} {0} -t {1}{2}@@% -o {3}{4}/{5}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 3, rijecnik[1][prva_rijec], rijecnik[0][druga_rijec], folder_path, folder, txt_broj + 18))
