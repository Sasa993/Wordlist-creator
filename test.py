...
def dvije_rijeci_druga_numeric(prva_rijec, druga_rijec, folder, rijecnik, txt_broj):
	...
	os.system("crunch {0} {0} -t %%%%{1}{2} -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 4, rijecnik[0][prva_rijec], rijecnik[1][druga_rijec], folder, txt_broj + 3))
	neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 3))
	os.system("crunch {0} {0} -t %{1}%{2} -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 2, rijecnik[0][prva_rijec], rijecnik[1][druga_rijec], folder, txt_broj + 4))
	neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 4))
	os.system("crunch {0} {0} -t %%{1}%{2} -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 3, rijecnik[0][prva_rijec], rijecnik[1][druga_rijec], folder, txt_broj + 5))
	neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 5))
	os.system("crunch {0} {0} -t %{1}%%{2} -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 3, rijecnik[0][prva_rijec], rijecnik[1][druga_rijec], folder, txt_broj + 6))
	neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 6))
	os.system("crunch {0} {0} -t %{1}%%%{2} -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 4, rijecnik[0][prva_rijec], rijecnik[1][druga_rijec], folder, txt_broj + 7))
	neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 7))
	os.system("crunch {0} {0} -t %%{1}%%{2} -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 4, rijecnik[0][prva_rijec], rijecnik[1][druga_rijec], folder, txt_broj + 8))
	neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 8))
	os.system("crunch {0} {0} -t %%%{1}%{2} -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 4, rijecnik[0][prva_rijec], rijecnik[1][druga_rijec], folder, txt_broj + 9))
	neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 9))
	os.system("crunch {0} {0} -t %{1}{2}% -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 2, rijecnik[0][prva_rijec], rijecnik[1][druga_rijec], folder, txt_broj + 10))
	neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 10))
	os.system("crunch {0} {0} -t %%{1}{2}% -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 3, rijecnik[0][prva_rijec], rijecnik[1][druga_rijec], folder, txt_broj + 11))
	neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 11))
	os.system("crunch {0} {0} -t %{1}{2}%% -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 3, rijecnik[0][prva_rijec], rijecnik[1][druga_rijec], folder, txt_broj + 12))
	neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 12))
	os.system("crunch {0} {0} -t %%{1}{2}%% -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 4, rijecnik[0][prva_rijec], rijecnik[1][druga_rijec], folder, txt_broj + 13))
	neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 13))
	os.system("crunch {0} {0} -t %%%{1}{2}% -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 4, rijecnik[0][prva_rijec], rijecnik[1][druga_rijec], folder, txt_broj + 14))
	neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 14))
	os.system("crunch {0} {0} -t %{1}{2}%%% -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 4, rijecnik[0][prva_rijec], rijecnik[1][druga_rijec], folder, txt_broj + 15))
	neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 15))
	#combo 2 names
	os.system("crunch {0} {0} -t %{1}{2} -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 1, rijecnik[1][prva_rijec], rijecnik[0][druga_rijec], folder, txt_broj + 16))
	neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 16))
	os.system("crunch {0} {0} -t %%{1}{2} -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 2, rijecnik[1][prva_rijec], rijecnik[0][druga_rijec], folder, txt_broj + 17))
	neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 17))
	os.system("crunch {0} {0} -t %%%{1}{2} -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 3, rijecnik[1][prva_rijec], rijecnik[0][druga_rijec], folder, txt_broj + 18))
	neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 18))
	os.system("crunch {0} {0} -t %%%%{1}{2} -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 4, rijecnik[1][prva_rijec], rijecnik[0][druga_rijec], folder, txt_broj + 19))
	neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 19))
	os.system("crunch {0} {0} -t %{1}%{2} -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 2, rijecnik[1][prva_rijec], rijecnik[0][druga_rijec], folder, txt_broj + 20))
	neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 20))
	os.system("crunch {0} {0} -t %%{1}%{2} -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 3, rijecnik[1][prva_rijec], rijecnik[0][druga_rijec], folder, txt_broj + 21))
	neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 21))
	os.system("crunch {0} {0} -t %{1}%%{2} -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 3, rijecnik[1][prva_rijec], rijecnik[0][druga_rijec], folder, txt_broj + 22))
	neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 22))
	os.system("crunch {0} {0} -t %{1}%%%{2} -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 4, rijecnik[1][prva_rijec], rijecnik[0][druga_rijec], folder, txt_broj + 23))
	neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 23))
	os.system("crunch {0} {0} -t %%{1}%%{2} -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 4, rijecnik[1][prva_rijec], rijecnik[0][druga_rijec], folder, txt_broj + 24))
	neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 24))
	os.system("crunch {0} {0} -t %%%{1}%{2} -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 4, rijecnik[1][prva_rijec], rijecnik[0][druga_rijec], folder, txt_broj + 25))
	neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 25))
	os.system("crunch {0} {0} -t %{1}{2}% -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 2, rijecnik[1][prva_rijec], rijecnik[0][druga_rijec], folder, txt_broj + 26))
	neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 26))
	os.system("crunch {0} {0} -t %%{1}{2}% -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 3, rijecnik[1][prva_rijec], rijecnik[0][druga_rijec], folder, txt_broj + 27))
	neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 27))
	os.system("crunch {0} {0} -t %{1}{2}%% -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 3, rijecnik[1][prva_rijec], rijecnik[0][druga_rijec], folder, txt_broj + 28))
	neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 28))
	os.system("crunch {0} {0} -t %%{1}{2}%% -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 4, rijecnik[1][prva_rijec], rijecnik[0][druga_rijec], folder, txt_broj + 29))
	neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 29))
	os.system("crunch {0} {0} -t %%%{1}{2}% -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 4, rijecnik[1][prva_rijec], rijecnik[0][druga_rijec], folder, txt_broj + 30))
	neki_tamo_brojac += os.path.getsize('/root/Documents/{0}/{1}.txt'.format(folder, txt_broj + 30))
	os.system("crunch {0} {0} -t %{1}{2}%%% -o /root/Documents/{3}/{4}.txt".format(rijecnik[0]['rijec_duzina'] + rijecnik[1]['rijec_duzina'] + 4, rijecnik[1][prva_rijec], rijecnik[0][druga_rijec], folder, txt_broj + 31))
...
def dvije_rijeci_prva_upper_alpha():
	global neki_tamo_brojac
...
def dvije_rijeci_druga_upper_alpha():
	global neki_tamo_brojac
